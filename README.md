...
- **🛡️ 4-Pillar Robust Architecture**: `ExitManager`, `MarketAnalyzer`, `RecoveryEngine`, `VibeAlphaEngine` 4대 핵심 모듈이 독립적이면서도 유기적으로 협력하여 자산을 안전하게 관리합니다.
...
4.  **VibeAlphaEngine**: 네이버 금융 랭킹과 펀더멘털 데이터를 AI 점수로 환산하여 유망 종목을 발굴합니다.
